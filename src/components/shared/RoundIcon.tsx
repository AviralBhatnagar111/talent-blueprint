import {
  ClipboardCheck, Brain, Code2, Mic, Users, UserCheck, FileText, CheckCircle2, Bot, Video,
} from 'lucide-react';
...
export const ROUND_META: Record<RoundType, { icon: any; name: string; description: string; tone: string }> = {
  ...
  OneWayInterview: { icon: Video, name: 'One-Way Interview', description: 'Async recorded video interview with AI evaluation', tone: 'bg-primary/10 text-primary' },
